...
class ServiceRegistry:
    ...
    def register(self,
                 ...
                 scope: ServiceScope = ServiceScope.SINGLETON,
                 tags: List[str] = None,
                 metadata: Dict[str, Any] = None) -> 'ServiceRegistry':
        """
        註冊服務
    ...
    def register_singleton(self,
                          service_type: Type,
                          implementation: Union[Type, Callable, Any] = None,
                          **kwargs) -> 'ServiceRegistry':
        """註冊單例服務"""
        return self.register(service_type, implementation, ServiceScope.SINGLETON, **kwargs)
    ...
    def register_transient(self,
                          ...
                          **kwargs) -> 'ServiceRegistry':
        """註冊瞬態服務"""
        return self.register(service_type, implementation, ServiceScope.TRANSIENT, **kwargs)
    ...
    def register_scoped(self,
                       ...
                       **kwargs) -> 'ServiceRegistry':
        """註冊作用域服務"""
        return self.register(service_type, implementation, ServiceScope.SCOPED, **kwargs)
    
    def register_factory(self,
                        service_type: Type,
                        factory: Callable[['ServiceProvider'], Any],
                        scope: ServiceScope = ServiceScope.SINGLETON) -> 'ServiceRegistry':
        """
        註冊工廠函數
    ...
    def create_provider(self, scope_context: Optional[Dict[str, Any]] = None) -> 'ServiceProvider':
        """
        創建服務提供者
...
def get_service_provider(scope_context: Optional[Dict[str, Any]] = None) -> ServiceProvider:
    """獲取服務提供者"""
