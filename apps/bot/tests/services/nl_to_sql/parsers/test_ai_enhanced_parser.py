...
class TestAIEnhancedParser:
    ...
    class TestJSONResponseParsing:
        ...
        @pytest.mark.asyncio
        async def test_parse_json_with_unknown_query_type(self, parser, mock_ai_service):
            """測試未知查詢類型的 JSON 響應"""
            ai_response = {
    ...
    class TestTextResponseParsing:
        ...
        async def test_parse_text_response_with_sql(self, parser, mock_ai_service):
            ...
            # 模擬 AI 返回包含 SQL 的文字
            mock_ai_service.enhance_natural_language_query.return_value = (
                "SELECT * FROM machine_status WHERE machine_id = 'M001'", 0.8
            )
    ...
    class TestQueryTypeInference:
        ...
        def test_infer_query_type_from_sql(self, parser):
            ...
            test_cases = [
                ...
                ("SELECT * FROM status WHERE machine_id = 'M001'", QueryType.SPECIFIC_MACHINE),
            ]
    ...
    class TestParameterExtraction:
        ...
        async def test_extract_machine_id_from_sql(self, parser, mock_ai_service):
            ...
            mock_ai_service.enhance_natural_language_query.return_value = (sql_response, 0.8)
    ...
    class TestErrorHandling:
        ...
        async def test_parse_with_ai_service_exception(self, parser, mock_ai_service):
            """測試 AI 服務異常"""
            # 模擬 AI 服務拋出異常
            mock_ai_service.enhance_natural_language_query.side_effect = Exception("AI 服務錯誤")
    ...
    class TestEdgeCases:
        ...
        async def test_parse_very_long_input(self, parser, mock_ai_service):
            ...
            mock_ai_service.enhance_natural_language_query.return_value = (
                '{"query_type": "machine_status", "confidence": 0.8}', 0.8
            )
    ...
    class TestCapabilityAssessment:
        ...
        def test_can_handle_with_ai_service(self, parser):
            ...
            # 複雜查詢
            complex_query = "請分析加工部M001機台在過去一個月的故障情況，並與其他機台進行比較"
    ...
    class TestContextManagement:
        ...
        async def test_prepare_ai_context(self, parser, mock_ai_service):
            ...
            mock_ai_service.enhance_natural_language_query.return_value = ('{"query_type": "unknown"}', 0.8)
