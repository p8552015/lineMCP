...
class MachineFault(Base):
    ...
    fault_date = Column(DateTime, server_default=func.current_timestamp(), nullable=False)
...
class Order(Base):
    ...
    order_date = Column(DateTime, server_default=func.current_timestamp())  # 生產環境是 TIMESTAMP
