...
class MCPResponseParser:
    ...
    @staticmethod
    def parse_query_result(result: dict[str, Any] | str) -> list[dict[str, Any]]:
        """
        ...
        try:
            ...
            logger.debug(
                ...
                content_preview=(
                    str(result)[:200] if isinstance(result, str) else "dict"
                ),
            )
            ...
            if isinstance(data, dict) and "content" in data:
                ...
                try:
                    ...
                    if MCPResponseParser._is_error_text(text_content):
                        ...
                        # 嘗試錯誤恢復策略
                        recovered_data = MCPResponseParser._attempt_recovery(
                            text_content
                        )
    ...
    @staticmethod
    def _attempt_recovery(content: str) -> list | dict | None:
        """
        嘗試從損壞的 JSON 中恢復資料
    ...
    def _parse_error_text(content: str) -> dict[str, Any]:
        ...
        # 權限錯誤
            ...
            for word in ["permission", "unauthorized", "access denied"]
        ):
        ...
        # 網路/連接錯誤
            ...
            word in content_lower for word in ["timeout", "connection", "network"]
        ):
        ...
        # 服務不可用錯誤
            ...
            "service unavailable" in content_lower
            or "resource not available" in content_lower
        ):
    ...
    @staticmethod
    def parse_response(content: str | dict[str, Any]) -> dict[str, Any]:
        """
        智能解析各種格式的 MCP 回應
