...
from ..interfaces.server_interfaces import (
    IMCPServer, IMCPConnection, MCPServerConfig, MCPServerStatus,
    MCPConnectionInfo, MCPTool, MCPResource, MCPToolCall, MCPToolResult,
    ConnectionStatus
)
...
class MCPServerImpl(IMCPServer):
    ...
    def __init__(
        ...
        self._connection: Optional[IMCPConnection] = None
