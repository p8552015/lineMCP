...
class FlexBuilder:
    ...
    def build_excel_data_flex(
        self, filename: str, sheet_name: str, data: dict[str, Any]
    ) -> FlexMessage:
        rows = data.get("rows", [])
            ...
            contents.append(
                {
                    ...
                    "contents": [
                        ...
                        },
                        {
                            ...
                            "color": (
                                "#DC2626"
                                if machine.get("fault_count", 0) > 5
                                else "#059669"
                            ),
                            "flex": 1,
                            "align": "end",
    ...
    def build_suggestion_flex(
        self, machine_id: str, data: dict[str, Any]
    ) -> FlexMessage:
